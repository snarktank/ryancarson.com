...
I was able to transform myself into a Fullstack JavaScript Developer in a short amount of time, using [GPT-4](https://platform.openai.com/docs/introduction) + [NextJS](https://nextjs.org/) + [Clerk](https://clerk.com/) + [Stripe](https://stripe.com/) + [Vercel ai SDK](https://sdk.vercel.ai/docs) + [Sonny Sangha on YouTube](https://www.youtube.com/watch?v=OOUsvDOKlGs) and [codewithantonio on YouTube](https://www.youtube.com/watch?v=ffJ38dBzrlY&t=11110s).

</Callout>

<StaticTweet id="1730579412783882559" />
